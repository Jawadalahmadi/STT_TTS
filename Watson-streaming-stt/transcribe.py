...
auth = IAMAuthenticator('mwZYC_DVp9JrKsPPUtwFFOGayeA9tpdb-NX5qHLM4QTU')
authenticator = IAMAuthenticator('2yqWO10XFcwBsfGOvfM-_mmbmqf6WJwF_UFuD4uT7ig8')
text_to_speech = TextToSpeechV1(authenticator=authenticator)
tts = TextToSpeechV1(authenticator=auth)
text_to_speech.set_service_url('https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/68c8686f-dcff-46f9-a3c8-d3257fa16641')
tts.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/ba70de41-0685-4f70-a395-e2081c743917')
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        with open('./speech.mp3', 'wb') as audio_file:
            res = tts.synthesize(p, accept='audio/mp3', voice='en-US_AllisonV3Voice'). get_result()
